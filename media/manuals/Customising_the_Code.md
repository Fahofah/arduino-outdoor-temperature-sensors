...
<img src="/media/images/sensor_addresses_comment.png" width="50%" height="20%" alt="sensor_addresses_comment">

*Uncomment means deleting the leading double slashes //*

<img src="/media/images/sensor_addresses_uncomment.png" width="50%" height="20%" alt="sensor_addresses_uncomment">

2. Upload this version back and check the Serial Monitor for the IDs.
...
<img src="/media/images/sensor_addresses_variables.png" width="50%" height="20%" alt="sensor_addresses_variables">
...
<img src="/media/images/delay_and_fileName.png" width="50%" height="20%" alt="delay_and_fileName">
...
<img src="/media/images/digital_inputs.png" width="100%" height="20%" alt="digital_inputs">
